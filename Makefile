...
INSTALL_DIR = mkdir -p
BK_DEPS = /media/kyokukau/RIP Life/Projects/BlueMarten/_FeralHeartRedux/FH_Linux/FHR_Linux_Clean/mysql++-3.2.4/bk-deps
srcdir = .
...
DESTDIR = 
MYSQLPP_CXXFLAGS = -I. -I/usr/include/mysql $(PIC_FLAG)  \
	$(CPPFLAGS) $(CXXFLAGS)
MYSQLPP_OBJECTS =  \
	mysqlpp_beemutex.o \
	mysqlpp_cmdline.o \
...
SSQLS2PARSE_CXXFLAGS = -Ilib -I/usr/include/mysql -I.  \
	$(CPPFLAGS) $(CXXFLAGS)
SSQLS2PARSE_OBJECTS =  \
	ssqls2parse_parsev2.o
SSQLSXLAT_CXXFLAGS = -Ilib -I/usr/include/mysql  $(CPPFLAGS) \
	$(CXXFLAGS)
SSQLSXLAT_OBJECTS =  \
	ssqlsxlat_genv2.o \
	ssqlsxlat_main.o
TEST_ARRAY_INDEX_CXXFLAGS = -Ilib -I/usr/include/mysql  \
	$(CPPFLAGS) $(CXXFLAGS)
TEST_ARRAY_INDEX_OBJECTS =  \
	test_array_index_array_index.o
TEST_CPOOL_CXXFLAGS = -Ilib -I/usr/include/mysql  $(CPPFLAGS) \
	$(CXXFLAGS)
TEST_CPOOL_OBJECTS =  \
	test_cpool_cpool.o
TEST_DATETIME_CXXFLAGS = -Ilib -I/usr/include/mysql  $(CPPFLAGS) \
	$(CXXFLAGS)
TEST_DATETIME_OBJECTS =  \
	test_datetime_datetime.o
TEST_INTTYPES_CXXFLAGS = -Ilib -I/usr/include/mysql  $(CPPFLAGS) \
	$(CXXFLAGS)
TEST_INTTYPES_OBJECTS =  \
	test_inttypes_inttypes.o
TEST_INSERTPOLICY_CXXFLAGS = -Ilib -I/usr/include/mysql  \
	$(CPPFLAGS) $(CXXFLAGS)
TEST_INSERTPOLICY_OBJECTS =  \
	test_insertpolicy_insertpolicy.o
TEST_MANIP_CXXFLAGS = -Ilib -I/usr/include/mysql  $(CPPFLAGS) \
	$(CXXFLAGS)
TEST_MANIP_OBJECTS =  \
	test_manip_manip.o
TEST_NULL_COMPARISON_CXXFLAGS = -Ilib -I/usr/include/mysql  \
	$(CPPFLAGS) $(CXXFLAGS)
TEST_NULL_COMPARISON_OBJECTS =  \
	test_null_comparison_null_comparison.o
TEST_QUERY_COPY_CXXFLAGS = -Ilib -I/usr/include/mysql  \
	$(CPPFLAGS) $(CXXFLAGS)
TEST_QUERY_COPY_OBJECTS =  \
	test_query_copy_query_copy.o
TEST_QSSQLS_CXXFLAGS = -Ilib -I/usr/include/mysql  $(CPPFLAGS) \
	$(CXXFLAGS)
TEST_QSSQLS_OBJECTS =  \
	test_qssqls_qssqls.o
TEST_QSTREAM_CXXFLAGS = -Ilib -I/usr/include/mysql  $(CPPFLAGS) \
	$(CXXFLAGS)
TEST_QSTREAM_OBJECTS =  \
	test_qstream_qstream.o
TEST_SQLSTREAM_CXXFLAGS = -Ilib -I/usr/include/mysql  \
	$(CPPFLAGS) $(CXXFLAGS)
TEST_SQLSTREAM_OBJECTS =  \
	test_sqlstream_sqlstream.o
TEST_SSQLS2_CXXFLAGS = -Ilib -I/usr/include/mysql  $(CPPFLAGS) \
	$(CXXFLAGS)
TEST_SSQLS2_OBJECTS =  \
	test_ssqls2_ssqls2.o
TEST_STRING_CXXFLAGS = -Ilib -I/usr/include/mysql  $(CPPFLAGS) \
	$(CXXFLAGS)
TEST_STRING_OBJECTS =  \
	test_string_string.o
TEST_TCP_CXXFLAGS = -Ilib -I/usr/include/mysql  $(CPPFLAGS) \
	$(CXXFLAGS)
TEST_TCP_OBJECTS =  \
	test_tcp_tcp.o
TEST_UDS_CXXFLAGS = -Ilib -I/usr/include/mysql  $(CPPFLAGS) \
	$(CXXFLAGS)
TEST_UDS_OBJECTS =  \
	test_uds_uds.o
TEST_WNP_CXXFLAGS = -Ilib -I/usr/include/mysql  $(CPPFLAGS) \
	$(CXXFLAGS)
TEST_WNP_OBJECTS =  \
	test_wnp_wnp.o
EXCOMMON_CXXFLAGS = -Ilib -I/usr/include/mysql  $(CPPFLAGS) \
	$(CXXFLAGS)
EXCOMMON_OBJECTS =  \
	excommon_printdata.o
CGI_JPEG_CXXFLAGS = -Ilib -I/usr/include/mysql  $(CPPFLAGS) \
	$(CXXFLAGS)
CGI_JPEG_OBJECTS =  \
	cgi_jpeg_cgi_jpeg.o
CPOOL_CXXFLAGS = -Ilib -I/usr/include/mysql  $(CPPFLAGS) \
	$(CXXFLAGS)
CPOOL_OBJECTS =  \
	cpool_cpool.o
DBINFO_CXXFLAGS = -Ilib -I/usr/include/mysql  $(CPPFLAGS) \
	$(CXXFLAGS)
DBINFO_OBJECTS =  \
	dbinfo_dbinfo.o
DEADLOCK_CXXFLAGS = -Ilib -I/usr/include/mysql  $(CPPFLAGS) \
	$(CXXFLAGS)
DEADLOCK_OBJECTS =  \
	deadlock_deadlock.o
FIELDINF_CXXFLAGS = -Ilib -I/usr/include/mysql  $(CPPFLAGS) \
	$(CXXFLAGS)
FIELDINF_OBJECTS =  \
	fieldinf_fieldinf.o
FOR_EACH_CXXFLAGS = -Ilib -I/usr/include/mysql  $(CPPFLAGS) \
	$(CXXFLAGS)
FOR_EACH_OBJECTS =  \
	for_each_for_each.o
LOAD_JPEG_CXXFLAGS = -Ilib -I/usr/include/mysql  $(CPPFLAGS) \
	$(CXXFLAGS)
LOAD_JPEG_OBJECTS =  \
	load_jpeg_load_jpeg.o
MULTIQUERY_CXXFLAGS = -Ilib -I/usr/include/mysql  $(CPPFLAGS) \
	$(CXXFLAGS)
MULTIQUERY_OBJECTS =  \
	multiquery_multiquery.o
RESETDB_CXXFLAGS = -Ilib -I/usr/include/mysql  $(CPPFLAGS) \
	$(CXXFLAGS)
RESETDB_OBJECTS =  \
	resetdb_resetdb.o
SIMPLE1_CXXFLAGS = -Ilib -I/usr/include/mysql  $(CPPFLAGS) \
	$(CXXFLAGS)
SIMPLE1_OBJECTS =  \
	simple1_simple1.o
SIMPLE2_CXXFLAGS = -Ilib -I/usr/include/mysql  $(CPPFLAGS) \
	$(CXXFLAGS)
SIMPLE2_OBJECTS =  \
	simple2_simple2.o
SIMPLE3_CXXFLAGS = -Ilib -I/usr/include/mysql  $(CPPFLAGS) \
	$(CXXFLAGS)
SIMPLE3_OBJECTS =  \
	simple3_simple3.o
SSQLS1_CXXFLAGS = -Ilib -I/usr/include/mysql  $(CPPFLAGS) \
	$(CXXFLAGS)
SSQLS1_OBJECTS =  \
	ssqls1_ssqls1.o
SSQLS2_CXXFLAGS = -Ilib -I/usr/include/mysql  $(CPPFLAGS) \
	$(CXXFLAGS)
SSQLS2_OBJECTS =  \
	ssqls2_ssqls2.o
SSQLS3_CXXFLAGS = -Ilib -I/usr/include/mysql  $(CPPFLAGS) \
	$(CXXFLAGS)
SSQLS3_OBJECTS =  \
	ssqls3_ssqls3.o
SSQLS4_CXXFLAGS = -Ilib -I/usr/include/mysql  $(CPPFLAGS) \
	$(CXXFLAGS)
SSQLS4_OBJECTS =  \
	ssqls4_ssqls4.o
SSQLS5_CXXFLAGS = -Ilib -I/usr/include/mysql  $(CPPFLAGS) \
	$(CXXFLAGS)
SSQLS5_OBJECTS =  \
	ssqls5_ssqls5.o
SSQLS6_CXXFLAGS = -Ilib -I/usr/include/mysql  $(CPPFLAGS) \
	$(CXXFLAGS)
SSQLS6_OBJECTS =  \
	ssqls6_ssqls6.o
STORE_IF_CXXFLAGS = -Ilib -I/usr/include/mysql  $(CPPFLAGS) \
	$(CXXFLAGS)
STORE_IF_OBJECTS =  \
	store_if_store_if.o
TQUERY1_CXXFLAGS = -Ilib -I/usr/include/mysql  $(CPPFLAGS) \
	$(CXXFLAGS)
TQUERY1_OBJECTS =  \
	tquery1_tquery1.o
TQUERY2_CXXFLAGS = -Ilib -I/usr/include/mysql  $(CPPFLAGS) \
	$(CXXFLAGS)
TQUERY2_OBJECTS =  \
	tquery2_tquery2.o
TQUERY3_CXXFLAGS = -Ilib -I/usr/include/mysql  $(CPPFLAGS) \
	$(CXXFLAGS)
TQUERY3_OBJECTS =  \
	tquery3_tquery3.o
TQUERY4_CXXFLAGS = -Ilib -I/usr/include/mysql  $(CPPFLAGS) \
	$(CXXFLAGS)
TQUERY4_OBJECTS =  \
	tquery4_tquery4.o
TRANSACTION_CXXFLAGS = -Ilib -I/usr/include/mysql  $(CPPFLAGS) \
	$(CXXFLAGS)
TRANSACTION_OBJECTS =  \
...
$(DLLPREFIX)mysqlpp$(__mysqlpp___targetsuf3): $(MYSQLPP_OBJECTS) lib/ssqls.h lib/querydef.h
	$(SHARED_LD_CXX) $@ $(MYSQLPP_OBJECTS)  $(__mysqlpp___importlib) $(__mysqlpp___soname_flags)   $(__mysqlpp___macinstnamecmd) -L/usr/lib -lmysqlclient   $(LDFLAGS)  $(LIBS)
...
mysql++-3.2.4: 
	...
	Makefile.* mysql++.* osver mysql++-3.2.4
	for d in vc200? ; do \
	mkdir -p mysql++-3.2.4/$$d ; \
	cp $$d/*.sln $$d/*.vcproj mysql++-3.2.4/$$d ; \
	done
	cp config/*.m4 mysql++-3.2.4/config
	cp doc/userman/userman.dbx.in mysql++-3.2.4/doc/userman
	for e in cpp h jpg txt ; \
	do \
	cp examples/*.$$e mysql++-3.2.4/examples ; \
	done
	for d in mfc wforms ; \
	do \
	mkdir -p mysql++-3.2.4/examples/vstudio/$$d ; \
	cp examples/vstudio/$$d/* mysql++-3.2.4/examples/vstudio/$$d ; \
	done
	cp lib/*.cpp lib/*.h lib/*.in lib/*.pl mysql++-3.2.4/lib
	cp test/*.cpp mysql++-3.2.4/test
	cp ssx/*.cpp ssx/*.h ssx/*.in mysql++-3.2.4/ssx
	cd mysql++-3.2.4 ; ./bootstrap nodoc nomaint
	rm -f mysql++-3.2.4/Makefile
	rm -f mysql++-3.2.4/config.log
	rm -f mysql++-3.2.4/config.status
	rm -fr mysql++-3.2.4/autom4te.cache
	find . -name '._*' -type f -delete

abicheck: 
	abi-compliance-checker -lib mysqlpp -dump abi.xml
	abi-compliance-checker -lib mysqlpp \
	-old ../3.1.0/abi_dumps/mysqlpp/mysqlpp_3.1.0.abi.tar.gz \
	-new ./abi_dumps/mysqlpp/mysqlpp_3.2.4.abi.tar.gz
	mv compat_reports/mysqlpp/*/compat_report.html ~/Desktop
	find compat_reports -empty -delete

dist: doc mysql++-3.2.4
	tar -chz -f mysql++-3.2.4.tar.gz mysql++-3.2.4
	rm -rf mysql++-3.2.4

rpm-prep: dist
	cp mysql++-3.2.4.tar.gz ~/rpmbuild/SOURCES
	cd ~/rpmbuild/SPECS
...
ebuild: dist
	cp mysql++-3.2.4.tar.gz /usr/portage/distfiles
	cp mysql++.ebuild /usr/portage/dev-db/mysql++/mysql++-3.2.4.ebuild
	ebuild /usr/portage/dev-db/mysql++/mysql++-3.2.4.ebuild digest
